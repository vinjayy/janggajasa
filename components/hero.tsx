...
export function Hero() {
  return (
    <div className="relative bg-gradient-to-r from-emerald-500 to-teal-600 overflow-hidden py-12 md:py-20">
          ...
          <main className="mx-auto max-w-3xl">
            <div>
              <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                ...
                <span className="block text-teal-200">untuk Kebutuhan Anda</span>
              </h1>
              <p className="mt-3 text-base text-white sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl">
                Janggajasa menyediakan berbagai layanan profesional untuk membantu menyelesaikan kebutuhan rumah tangga,
                pendidikan, dan bisnis Anda dengan kualitas terbaik.
              </p>
              ...
              <div className="mt-8 sm:flex sm:justify-center">
                <div className="rounded-md shadow">
                  <Button
                    ...
                    onClick={() => window.open(`https://wa.me/628141325200`, "_blank")}
                  >
                    Pesan Sekarang
                  </Button>
                </div>
