      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          ...
          <div className="mt-10 lg:mt-0">
            <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">Tentang Janggajasa</h2>
            <p className="mt-4 text-lg text-gray-500">
              Janggajasa adalah penyedia layanan terpercaya yang telah melayani ribuan pelanggan dengan berbagai
